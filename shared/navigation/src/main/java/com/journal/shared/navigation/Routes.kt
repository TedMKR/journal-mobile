...
object Routes {
    ...
    const val TEACHER_JOURNAL = "teacher_journal/{groupId}/{disciplineId}/{periodId}"
    ...
    fun teacherJournal(groupId: String, disciplineId: String, periodId: String): String =
        "teacher_journal/$groupId/$disciplineId/$periodId"
}
