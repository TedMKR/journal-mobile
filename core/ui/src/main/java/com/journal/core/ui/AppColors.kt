...
/** Основной тёмно-синий цвет: кнопки, заголовки, текст, акценты */
...
/** Второстепенный/приглушённый текст */
val AppSecondaryText = Color(0xFF7E8E99)

/** Второстепенный текст, более тёмный вариант */
...
/** Фон шапок таблиц, чипов, бейджей */
val AppHeaderBackground = Color(0xFFD3D7E1)

/** Фон карточек занятий, светло-синий акцент */
